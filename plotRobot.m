...
function feasible=plotRobot(position,direction,map,robotHalfDiagonalDistance,Color)
% plot robot with specified configuration and check its feasibility
 ...
 line([corner1(2);corner2(2);corner3(2);corner4(2);corner1(2)],[corner1(1);corner2(1);corner3(1);corner4(1);corner1(1)],'color',Color,'LineWidth',1);
